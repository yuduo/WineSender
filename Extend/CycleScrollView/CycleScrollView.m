...
//        UIImage *currentPageImage = [UIImage imageNamed:@"btn_home_banner_s"];
        ;
//        UIImage *inactivePageImage = [UIImage imageNamed:@"btn_home_banner_s"];
        [self.pageControl setPageIndicatorImage:[UIImage imageNamed:@"btn_home_point_n.png"]];
        [self.pageControl setCurrentPageIndicatorImage:[UIImage imageNamed:@"btn_home_point_s.png"]];
